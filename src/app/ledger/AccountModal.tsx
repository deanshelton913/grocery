  ...
  return (
    ...
    >
      ...
      >
        ...
        <div>
          <div
            className="font-body text-[11px] uppercase tracking-wide mb-1"
        ...
        <div>
          ...
          <p className="font-body text-[11px] mb-2" style={{ color: C.inkSoft }}>
            Use this bearer token to call{" "}
            <code style={{ background: C.paperSoft, padding: "1px 4px", borderRadius: 4 }}>
              POST /api/agent
            </code>{" "}
            from any AI agent or script. Rate limited to 30 req/min.
          </p>
          <div className="flex items-center gap-2">
            <div
              className="flex-1 font-mono-ledger text-[11px] rounded-lg px-2.5 py-2 truncate"
            ...
            >
              <RefreshCw
                size={14}
                color={rotating ? C.inkSoft : C.rust}
                style={{ animation: rotating ? "spin 1s linear infinite" : "none" }}
              />
            </button>
          </div>
          {rotating && (
            <p className="font-body text-[11px] mt-1" style={{ color: C.inkSoft }}>
              Rotating… old token is now invalid.
            </p>
          )}
        </div>
        ...
        <form onSubmit={handleChangePassword} className="space-y-2">
          ...
          />
          {pwMsg && (
            <p className="font-body text-[11px]" style={{ color: pwMsg.ok ? C.sage : C.rust }}>
              {pwMsg.text}
            </p>
          )}
          <button
        ...
        <button
          ...
          className="w-full rounded-xl py-2 font-body text-sm"
